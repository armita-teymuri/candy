...
<head>
    ...
    <link rel="icon" type="image/x-icon" href="uploads/candy-icon.avif">
</head>

<body>
    <nav class="navbar navbar-expand-lg bg-body-tertiary my-nav">
        <div class="container-fluid">
            <a class="navbar-brand" href="/register">ثبت نام</a>
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                <form class="d-flex" role="search">
                    ...
                    <button class="btn btn-outline-success my-btn" type="submit">جستجو</button>
                </form>
            </div>
        </div>
    </nav>
